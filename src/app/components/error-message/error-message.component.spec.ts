...
describe('ErrorMessageComponent', () => {
  ...
  it('should show error message on field when touched and error present',() =>
  {
  ...
  it('should hide error message if not touched',() =>
  {
    component.field = new FormGroup({anyField : new FormControl()});
    component.field.setErrors({anyError: true});
    component.error = "anyError";
  ...
  it('should hide error messageif not touched, but no errors',() =>
  {
    component.field = new FormGroup({anyField : new FormControl()});
    component.field.markAsTouched();
    component.error = "anyError";
  ...
  it('should hide error messageif on field touched and has error, but different errors',() =>
  {
    component.field = new FormGroup({anyField : new FormControl()});
    component.field.markAsTouched();
    component.field.setErrors({anyError: true});
