...
//    it('should recover password with existing email ', (done) =>{
...
//    it('should recover password with not existing email and return error message ', (done) =>{
